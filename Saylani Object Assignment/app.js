...
//   firstName: "Muhammad",
//   lastName: "Salman",
//   email: "muhammadsalmanirshad5@gmail.com",
//   password: "456",
//   age: 23,
//   gender: "male",
//   city: "Karachi",
...
// const Student1 = new Person("Muhammad", "Salman", 23, 21541, "Ssuet");
// const Student2 = new Person("Kamran", "Ali", 24, 217981, "APS");
...
//   } else if (select.value === "ECO") {
//     localStorage.setItem("save", select.value);
//   } else if (select.value === "BBA") {
//     localStorage.setItem("save", select.value);
//   } else if (select.value === "MBA") {
//     localStorage.setItem("save", select.value);
//   }
// }
